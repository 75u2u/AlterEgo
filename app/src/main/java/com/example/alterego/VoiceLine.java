...
class VoiceLine {
    ...
    static class Mood {
        static final int HAPPY = R.drawable.girl_happy;
        static final int PISSED = R.drawable.girl_angry; // うんざり
        static final int ANNOYED = R.drawable.girl_angry; // いらいら
        static final int ANGRY = R.drawable.girl_angry;
        static final int BLUSH = R.drawable.girl_sad; // 赤面

        static final int SIDE = R.drawable.girl_normal;
        static final int SAD = R.drawable.girl_sad;
        static final int NORMAL = R.drawable.girl_normal;
        static final int SLEEPY = R.drawable.girl_normal;
        static final int WINKING = R.drawable.girl_sad; // 痙攣
        static final int DISAPPOINTED = R.drawable.girl_sad;
        static final int INDIFFERENT = R.drawable.girl_normal; // 無関心
        static final int SIDED_PLEASANT = R.drawable.girl_happy; // 楽しい
        static final int SIDED_WORRIED = R.drawable.girl_sad; // 心配した
    }
